const MariaGorettiPage = () => {
  return (
    <div className="w-full flex justify-center min-h-screen">
      <div className="max-w-prose py-20 px-4">
        <h1 className="text-4xl text-blue-primary font-semibold pb-8">Mengenal Santa Maria Goretti</h1>
        ...
        <p className="pb-4 text-justify">Maria Teresa Goretti lahir di dalam sebuah keluarga sederhana pada 16 Oktober 1890. Ia dan keluarganya dari Italia Timur menuju Italia Barat di usia enam tahun. Ayah dan keluarganya berharap bisa memperoleh kehidupan yang lebih baik di tempat yang baru.</p>
